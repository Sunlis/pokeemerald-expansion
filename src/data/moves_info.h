...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_HYDRO_PUMP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "to strike the foe."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 120 : 120, //110
        .type = TYPE_WATER,
        .accuracy = 80,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SUBMISSION] =
    {
        ...
        .description = COMPOUND_STRING(
            "A reckless slam and hold\n"
            "for 4-5 turns, hurts user."),
        .effect = EFFECT_RECOIL,
        .power = 90,
        .type = TYPE_FIGHTING,
        .accuracy = 90,
    ...
    [MOVE_FIRE_SPIN] =
    {
        ...
        .type = TYPE_FIRE,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_5 ? 90 : 70, //was 85 : 70
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_DIG] =
    {
        ...
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 100 : 60, //90 : 60
        .type = TYPE_GROUND,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SMOG] =
    {
        ...
        .accuracy = 85,
        .pp = 25,
        .target = MOVE_TARGET_BOTH,    //selected previously 
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_POISON,
    ...
    [MOVE_SKULL_BASH] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 140 : 100, //130 : 100
        .type = TYPE_ROCK,
        .accuracy = 100,
    ...
    [MOVE_SNORE] =
    {
        ...
        .effect = EFFECT_SNORE,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 60 : 40, //50 : 40
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_ZAP_CANNON] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 110 : 100,
        .type = TYPE_ELECTRIC,
        .accuracy = 70,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_ROCK_SMASH] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 50 : 20,    //40
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_WHIRLPOOL] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 40 : 15, //originally was 35 : 15
        .type = TYPE_WATER,
    ...
    [MOVE_SMELLING_SALTS] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 65 : 60,    //70
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 15,   //10
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_KNOCK_OFF] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 55 : 20,    //-10
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_DIVE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "turn and strikes next turn."),
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 90 : 60, //80 : 60
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SAND_TOMB] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 35 : 15,
        .type = TYPE_GROUND,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_5 ? 90 : 70, //originally was 85 : 90
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_MIRACLE_EYE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Negate evasion and Dark's\n"
            "immunities. -Atk and SpA."),
    ...
    [MOVE_FEINT] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 40 : 50, //was 30 : 50
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_CHATTER] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 70 : 60, //65 : 60
        .type = TYPE_FLYING,
        .accuracy = 100,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_DARK_VOID] =
    {
        ...
        .power = 0,
        .type = TYPE_DARK,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_7 ? 65 : 80, // 50 :80
        .pp = 10,
        .target = MOVE_TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
    ...
    [MOVE_FROST_BREATH] =
    {
        ...
        .description = sStormThrowDescription,
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 65 : 40, //used to be 60 : 40
        .type = TYPE_ICE,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_ZIPPY_ZAP] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 50 : 50, // 80 : 50
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_8 ? 15 : 15, // 10 : 15
        .target = MOVE_TARGET_SELECTED,
        .priority = 2,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_GLITZY_GLOW] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 70 : 90,    //80:90
        .type = TYPE_PSYCHIC,
    ...
    [MOVE_SAPPY_SEED] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 90 : 90,   //100:90
        .type = TYPE_GRASS,
    ...
    [MOVE_FREEZY_FROST] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Eliminates all stat changes."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 80 : 90,   //100 : 90
        .type = TYPE_ICE,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_8 ? 90 : 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_8 ? 10 : 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SPARKLY_SWIRL] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_8 ? 100 : 90,   //120:90
        .type = TYPE_FAIRY,
    ...
    [MOVE_WICKED_BLOW] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 70 : 80, //75 : 80
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_GLACIAL_LANCE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 90 : 130, //120 : 130
        .type = TYPE_ICE,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_BOTH,
    ...
    [MOVE_TRIPLE_ARROWS] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 80 : 50, //90 : 50
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_9 ? 10 : 15,
        .criticalHitStage = 1,
    ...
    [MOVE_VINE_STORM] =
    {
        .name = COMPOUND_STRING("Vine Storm"),
        .description = COMPOUND_STRING(
            "A torrent of angry vines\n"
    ...
    [MOVE_LUMINATION] =
    {
        .name = COMPOUND_STRING("Lumination"),
        .description = COMPOUND_STRING(
            "A high voltage burst of\n"
            "light, changes terrain."),
        .effect = EFFECT_HIT,
        .power = 55,
        .type = TYPE_ELECTRIC,
        .accuracy = 90,
    ...
    [MOVE_MINDSTORM] =
    {
        ...
        .description = COMPOUND_STRING(
            "A high power burst of\n"
            "psionics, changes terrain."),
        .effect = EFFECT_HIT,
        .power = 55,
        .type = TYPE_PSYCHIC,
        .accuracy = 90,
    ...
    [MOVE_MAGNESURGE] =
    {
        .name = COMPOUND_STRING("Magnesurge"),
        .description = COMPOUND_STRING(
            "A surge of gravitational\n"
            "energy that lingers."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_SEARING_BLAST] =
    {
        .name = COMPOUND_STRING("SearingBlast"),
        .description = COMPOUND_STRING(
            "An intense flame that\n"
            "ignores abilities."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_FIRE,
    ...
    [MOVE_PIERCING_JET] =
    {
        .name = COMPOUND_STRING("Piercing Jet"),
        .description = COMPOUND_STRING(
            "A aquatic beam that\n"
            "ignores abilities."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_LEAF_SHURIKEN] =
    {
        .name = COMPOUND_STRING("LeafShuriken"),
        .description = COMPOUND_STRING(
            "A swift leaf strike that\n"
            "ignores abilities."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_GRASS,
    ...
    [MOVE_QUICK_STING] =
    {
        .name = COMPOUND_STRING("Quick Sting"),
        .description = COMPOUND_STRING(
            "An extremely fast attack\n"
            "that always strikes first."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_COMPOST_BLAST] =
    {
        .name = COMPOUND_STRING("CompostBlast"),
        .description = COMPOUND_STRING(
            "Attacks with compost ball.\n"
            "May poison foes."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_GRASS,
    ...
    [MOVE_PSI_PUNCH] =
    {
        .name = COMPOUND_STRING("Psi-Punch"),
        .description = COMPOUND_STRING(
            "Does double damage if the\n"
            "foe is asleep."),
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
    ...
    [MOVE_SMITE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Attacks with wrathful\n"
            "light, may confuse foes."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 90 : 95,
        .type = TYPE_FAIRY,
        .accuracy = 95,
    ...
    [MOVE_DEPLETION_RAY] =
    {
        .name = COMPOUND_STRING("DepletionRay"),
        .description = COMPOUND_STRING(
            "Attacks with ghastly power.\n"
            "Foe's last move has 3 PP cut."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_GHOST,
    ...
    [MOVE_TREMOR_RUSH] =
    {
        .name = COMPOUND_STRING("Tremor Rush"),
        .description = COMPOUND_STRING(
            "An extremely fast attack\n"
            "that always strikes first."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_SAND_BLAST] =
    {
        ...
        .description = COMPOUND_STRING(
            "Traps and hurts the foe in a storm\n"
            "of sand for "BINDING_TURNS" turns."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 80 : 15,
        .type = TYPE_GROUND,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_5 ? 85 : 70, //originally was 85 : 90
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_CANNONBALL] =
    {
        .name = COMPOUND_STRING("Cannonball"),
        .description = COMPOUND_STRING(
            "An all out charge. If it\n"
            "misses, the user is hurt."),
        #if B_UPDATED_MOVE_DATA >= GEN_5
            .power = 130,
        #elif B_UPDATED_MOVE_DATA == GEN_4
    ...
    [MOVE_JET_FLARE] =
    {
        .name = COMPOUND_STRING("Jet Flare"),
        .description = COMPOUND_STRING(
            "Strikes first by dashing\n"
            "fire at the foe at a high speed."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_LINK_PULSE] =
    {
        .name = COMPOUND_STRING("Link Pulse"),
        .description = COMPOUND_STRING(
            "Explodes on foes, but\n"
            "restores ally's HP."),
        .effect = EFFECT_HIT_ENEMY_HEAL_ALLY,
    ...
    [MOVE_DRACO_FLARE] =
    {
        .name = COMPOUND_STRING("Draco Flare"),
        .description = COMPOUND_STRING(
            "Creates a huge wave of dragon\n"
            "breath raining on the foe."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 90 : 95,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_SCALE_RAIN] =
    {
        .name = COMPOUND_STRING("Scale Rain"),
        .description = COMPOUND_STRING(
            "Attacks with its scales,\n"
    ...
    [MOVE_DRAGON_DASH] =
    {
        .name = COMPOUND_STRING("Dragon Dash"),
        .description = COMPOUND_STRING(
            "Attacks in a cloak of\n"
            "draconic fury. Raises Speed."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_DRAGON,
        .accuracy = 100,
    ...
    [MOVE_DARK_DIRGE] =
    {
        .name = COMPOUND_STRING("Dark Dirge"),
        .description = COMPOUND_STRING(
            "A eerie song that uses\n"
            "sound waves to injure."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_DARK,
    ...
    [MOVE_WIND_FURY] =
    {
        .name = COMPOUND_STRING("Wind Fury"),
        .description = COMPOUND_STRING(
            "Expells powerful winds outward.\n"
            "May clear the field."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_FLYING,
    ...
    [MOVE_ROUNDHOUSE] =
    {
        .name = COMPOUND_STRING("Roundhouse"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ECHO_BURN] =
    {
        .name = COMPOUND_STRING("Echo Burn"),
        .description = COMPOUND_STRING(
            "An intense sound blast that\n"
            "may cause flinching."),
        .effect = EFFECT_HIT,
        .power = 110,
        .type = TYPE_NORMAL,
    ...
    [MOVE_RAIN_CALL] =
    {
        .name = COMPOUND_STRING("Rain Calll"),
        .description = COMPOUND_STRING(
            "A barrage of stormy\n"
            "weather that generates rain."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_WATER,
        .accuracy = 90,
    ...
    [MOVE_PUZZLE_PULSE] =
    {
        .name = COMPOUND_STRING("Puzzle Pulse"),
        .description = COMPOUND_STRING(
            "Attacks with ultrasonic\n"
            "waves. May confuse the foe."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_TORRENT_WEB] =
    {
        .name = COMPOUND_STRING("Torrent Web"),
        .description = COMPOUND_STRING(
            "A web strike that may cause\n"
            "flinching and slows the opponent."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_BUG,
        .accuracy = 95,
    ...
    [MOVE_SWEET_FINALE] =
    {
        .name = COMPOUND_STRING("Sweet Finale"),
        .description = COMPOUND_STRING(
            "Attacks in a cloak of\n"
            "intense light. Heals allies."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_FAIRY,
        .accuracy = 100,
    ...
    [MOVE_BLAZE_O_FURY] =
    {
        .name = COMPOUND_STRING("Blaze o' Fury"),
        .description = COMPOUND_STRING(
            "Shoots 2 to 5 flames in a row\n"
            "to strike the foe."),
        .effect = EFFECT_MULTI_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 25 : 10,
        .type = TYPE_FIRE,
    ...
    [MOVE_BANSHEE_SCREAM] =
    {
        .name = COMPOUND_STRING("Banshee Scream"),
        .description = COMPOUND_STRING(
            "A chilling scream that may\n"
            "frostbite the foe."),
    ...
    [MOVE_AURORA_STREAM] =
    {
        .name = COMPOUND_STRING("Aurora Stream"),
        .description = COMPOUND_STRING(
            "Shoots chilling water at the\n"
    ...
    [MOVE_ROCKET_JUMP] =
    {
        .name = COMPOUND_STRING("Rocket Jump"),
        .description = COMPOUND_STRING(
            "Flies up on the first turn,\n"
            "then strikes the next turn."),
        .effect = EFFECT_SEMI_INVULNERABLE,
    ...
    [MOVE_FAIRY_SLAP] =
    {
        .name = COMPOUND_STRING("Fairy Slap"),
        .description = COMPOUND_STRING(
            "Repeatedly slaps the foe\n"
            "2 to 5 times."),
        .effect = EFFECT_MULTI_HIT,
    ...
    [MOVE_MYTHIC_BLOW] =
    {
        .name = COMPOUND_STRING("Mythic Blow"),
        .description = sCloseCombatDescription,
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_FAIRY,
    ...
    [MOVE_SPARKLESTRIKE] =
    {
        .name = COMPOUND_STRING("Sparkle Strike"),
        .description = COMPOUND_STRING(
            "Hits with sparkling might.\n"
            "May cause flinching."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_FAIRY,
    ...
    [MOVE_DARK_DART] =
    {
        .name = COMPOUND_STRING("Dark Dart"),
        .description = COMPOUND_STRING(
            "Shoots a sinister bolt.\n"
            "May cause flinching."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_DARK,
    ...
    [MOVE_DOOM_DUST] =
    {
        .name = COMPOUND_STRING("Doom Dust"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_FIRE_DRIFT] =
    {
        .name = COMPOUND_STRING("Fire Drift"),
        .description = COMPOUND_STRING(
            "Charges the foe with speed\n"
            "and fire, may cause flinching."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_DARK_SURGE] =
    {
        .name = COMPOUND_STRING("Dark Surge"),
        .description = COMPOUND_STRING(
            "Allows a full-power attack,\n"
            "but sharply lowers Sp. Atk."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_FINAL_MIGHT] =
    {
        .name = COMPOUND_STRING("Final Might"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MERCURY_BEAM] =
    {
        .name = COMPOUND_STRING("Mercury Beam"),
        .description = COMPOUND_STRING(
            "A strange beam attack that\n"
            "may poison the foe."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_TITANIUM_BLOW] =
    {
        .name = COMPOUND_STRING("Titanium Blow"),
        .description = sCloseCombatDescription,
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_STEEL,
    ...
    [MOVE_TALON_STRIKE] =
    {
        .name = COMPOUND_STRING("Talon Strike"),
        .description = COMPOUND_STRING(
            "Rakes the foe with talons.\n"
            "Can lower Defense."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_FLYING,
    ...
    [MOVE_AURA_BARRAGE] =
    {
        .name = COMPOUND_STRING("Aura Barrage"),
        .description = COMPOUND_STRING(
            "Attacks with aura blasts\n"
            "that cannot be evaded."),
        .effect = EFFECT_MULTI_HIT,
        .power = 15,
        .type = TYPE_FIGHTING,
    ...
    [MOVE_AURA_REND] =
    {
        .name = COMPOUND_STRING("Aura Rend"),
        .description = COMPOUND_STRING(
            "Allows a full-power attack,\n"
            "but sharply lowers Sp. Atk."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_STEELSURGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "A powerful metal slam. Sets\n"
            "metal shrapnel that hurt the foe."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_STEEL,
        .accuracy = 90,
    ...
    [MOVE_SHRAPNEL] =
    {
        .name = COMPOUND_STRING("Shrapnel"),
        .description = COMPOUND_STRING(
            "Sets floating metal spikes that\n"
            "hurt a foe switching in."),
    ...
    [MOVE_FROST_BLADE] =
    {
        .name = COMPOUND_STRING("Frost Blade"),
        .description = COMPOUND_STRING(
            "Slashes with claws, etc. Has\n"
            "a high critical-hit ratio."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_ANTENNAE_WHIP] =
    {
        .name = COMPOUND_STRING("Antennae Whip"),
        .description = COMPOUND_STRING(
            "Strikes with vicious force.\n"
            "May cause flinching."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_BUG,
    ...
    [MOVE_LOCUST_SWARM] =
    {
        .name = COMPOUND_STRING("Locust Swarm"),
        .description = COMPOUND_STRING(
            "Allows a full-power attack,\n"
            "but sharply lowers Sp. Atk."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_ASTRAL_WAVE] =
    {
        .name = COMPOUND_STRING("Astral Wave"),
        .description = COMPOUND_STRING(
            "Creates a huge wave, then\n"
    ...
    [MOVE_CHLOROSTRIKE] =
    {
        .name = COMPOUND_STRING("Chlorostrike"),
        .description = COMPOUND_STRING(
            "A sun powered strike that's\n"
    ...
    [MOVE_BRUTAL_BUZZ] =
    {
        .name = COMPOUND_STRING("Brutal Buzz"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CORROSHOT] =
    {
        .name = COMPOUND_STRING("Corro-shot"),
        .description = COMPOUND_STRING(
            "A corrosive bolt\n"
            "that may badly poison."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_RUPTURE_PULSE] =
    {
        .name = COMPOUND_STRING("Rupture Pulse"),
        .description = COMPOUND_STRING(
            "Powerful ruptured earth hit foe\n"
            "and destroy the terrain."),
        .effect = EFFECT_HIT_SET_REMOVE_TERRAIN,
        .power = 80,
        .type = TYPE_GROUND,
    ...
    [MOVE_VOLT_SPIN] =
    {
        .name = COMPOUND_STRING("Volt Spin"),
        .description = COMPOUND_STRING(
            "Erases trap moves and Leech\n"
            "Seed. Paralyze adjacent foes."),
        .effect = EFFECT_RAPID_SPIN,
        .power = 30,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_STUN_BREAK] =
    {
        .name = COMPOUND_STRING("Stun Break"),
        .description = COMPOUND_STRING(
            "Does double damage if the\n"
            "foe is paralyzed."),
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
    ...
    [MOVE_MOMENTOUS_BLOW] =
    {
        .name = COMPOUND_STRING("Momentous Blow"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_VOLCANIC_CHARGE] =
    {
        .name = COMPOUND_STRING("Volcanic Charge"),
        .description = COMPOUND_STRING(
            "Does double damage if the\n"
            "foe is burned."),
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
    ...
    [MOVE_COLOSSAL_FLARE] =
    {
        .name = COMPOUND_STRING("Colossal Flare"),
        .description = COMPOUND_STRING(
            "Intensely powerful explosion,\n"
            "stronger if supereffective."),
        .effect = EFFECT_COLLISION_COURSE,
        .power = 90,
        .type = TYPE_FIRE,
    ...
    [MOVE_HARPOON_DIVE] =
    {
        .name = COMPOUND_STRING("Harpoon Dive"),
        .description = COMPOUND_STRING(
            "A user-hurting blow of\n"
            "high velocity."),
        .effect = EFFECT_MAX_HP_50_RECOIL,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 150 : 120,
        .type = TYPE_WATER,
    ...
    [MOVE_TORRENTIAL_RUSH] =
    {
        .name = COMPOUND_STRING("Torrential Rush"),
        .description = COMPOUND_STRING(
            "Foe's attacks next turn can't\n"
            "miss and do double damage."),
        .effect = EFFECT_GLAIVE_RUSH,
        .power = 130,
        .type = TYPE_WATER,
    ...
    [MOVE_RAPIDFIRE_BURST] =
    {
        .name = COMPOUND_STRING("Rapidfire Burst"),
        .description = COMPOUND_STRING(
            "Shoots 2 to 5 bursts in a row\n"
            "to strike the foe."),
        .effect = EFFECT_MULTI_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 25 : 10,
        .type = TYPE_STEEL,
    ...
    [MOVE_SNOWSEAR_STORM] = //is this just shittier blizzard?
    {
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
        .windMove = TRUE,
        .alwaysHitsInHailSnow = B_BLIZZARD_HAIL,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_FROSTBITE,
            .chance = 20,
        }),
    ...
    [MOVE_GLACIAL_STING] =
    {
        .name = COMPOUND_STRING("Glacial Sting"),
        .description = COMPOUND_STRING(
            "Lowers the foe's speed\n"
            "each turn for 3 turns."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_RAPID_FREEZE] =
    {
        .name = COMPOUND_STRING("Rapid Freeze"),
        .description = COMPOUND_STRING(
            "Erases trap moves and Leech\n"
            "Seed. Adjacent foes are frostbitten."),
        .effect = EFFECT_RAPID_SPIN,
        .power = 30,
        .type = TYPE_ICE,
        .accuracy = 100,
    ...
    [MOVE_TURBULENT_DIVE] =
    {
        .name = COMPOUND_STRING("Turbulent Dive"),
        .description = COMPOUND_STRING(
            "Intensely powerful strike,\n"
            "stronger if supereffective."),
        .effect = EFFECT_COLLISION_COURSE,
        .power = 90,
        .type = TYPE_FLYING,
    ...
    [MOVE_GIGATON_PUNCH] =
    {
        .name = COMPOUND_STRING("Gigaton Punch"),
        .description = COMPOUND_STRING(
            "Swings with momentous force. Can't\n"
            "be used twice in a row."),
        .effect = EFFECT_HIT,
        .power = 160,
        .type = TYPE_FIGHTING,
    ...
    [MOVE_FICKLE_STRIKE] =
    {
        .name = COMPOUND_STRING("Fickle Strike"),
        .description = COMPOUND_STRING(
            "Swings unpredictably. Sometimes\n"
            "twice as strong."),
        .effect = EFFECT_FICKLE_BEAM,
        .power = 85,
        .type = TYPE_NORMAL,
    ...
    [MOVE_TONGUE_LASH] =
    {
        .name = COMPOUND_STRING("Tongue lash"),
        .description = COMPOUND_STRING(
            "Does double damage if the\n"
            "foe has a status problem."),
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
    ...
    [MOVE_CHAMELEE] =
    {
        .name = COMPOUND_STRING("Cha-melee"),
        .description = COMPOUND_STRING(
            "Slashes using current type of user,\n"
            "has high critical-hit ratio."),
        .effect = EFFECT_CURRENT_TYPE,
        .power = 70,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .criticalHitStage = 1,
    ...
    [MOVE_TOXIC_TUMBLE] =
    {
        .name = COMPOUND_STRING("Toxic Tumble"),
        .description = COMPOUND_STRING(
            "An attack lasting 5 turns\n"
            "with rising intensity. May psn."),
        .effect = EFFECT_ROLLOUT,
        .power = 30,
        .type = TYPE_POISON,
        .accuracy = 90,
    ...
    [MOVE_PETRIFY] =
    {
        ...
        .description = COMPOUND_STRING(
            "A mysterious glare changes the\n"
            "target into a Rock-type."),
        .effect = EFFECT_SOAK,
        .power = 0,
        .type = TYPE_ROCK,
        .accuracy = 100,
    ...
    [MOVE_CHLORO_DIVE] =
    {
        .name = COMPOUND_STRING("Chloro Dive"),
        .description = COMPOUND_STRING(
            "This attack does Grass\n"
            "and Flying-type damage."),
        .effect = EFFECT_TWO_TYPED_MOVE,
        .power = B_UPDATED_MOVE_DATA >= GEN_7 ? 100 : 80,
        .type = TYPE_GRASS,
    ...
    [MOVE_PRESSURE_POINT] =
    {
        .name = COMPOUND_STRING("Pressure Point"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PYROKENESIS] =
    {
        .name = COMPOUND_STRING("Pyrokenesis"),
        .description = COMPOUND_STRING(
            "This attack does Fire\n"
    ...
    [MOVE_STEEL_ROT] =
    {
        .name = COMPOUND_STRING("Steel Rot"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CONDUIT_BOMB] =
    {
        .name = COMPOUND_STRING("Conduit Bomb"),
        .description = COMPOUND_STRING(
            "Super effective on Steel-\n"
            "types. May cause Paralysis."),
        .effect = EFFECT_SUPER_EFFECTIVE_ON_ARG,
        .power = 70,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_DARK_BOLTS] =
    {
        .name = COMPOUND_STRING("Dark Bolts"),
        .description = COMPOUND_STRING(
            "This 2 hit attack does Dark\n"
            "and Electric-type damage."),
        .effect = EFFECT_TWO_TYPED_MOVE,
        .power = B_UPDATED_MOVE_DATA >= GEN_7 ? 50 : 80,
        .type = TYPE_ELECTRIC,
        .accuracy = 95,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_LUMINSPHERE] =
    {
        .name = COMPOUND_STRING("Luminsphere"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BARRICADE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Protects user and sets stealth\n"
            "rocks on contact."),
        .effect = EFFECT_PROTECT,
        .power = 0,
        .type = TYPE_ROCK,
    ...
    [MOVE_SONAR_WALL] =
    {
        .name = COMPOUND_STRING("Sonar Wall"),
        .description = COMPOUND_STRING(
            "Protects itself, lowering\n"
            "Sp. Def on contact."),
        .effect = EFFECT_PROTECT,
    ...
    [MOVE_ADRENALINE] =
    {
        .name = COMPOUND_STRING("Adrenaline"),
        .description = COMPOUND_STRING(
            "A mystical surge that ups\n"
            "Sp.Attack and Speed."),
        .effect = EFFECT_ADRENALINE,
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = 20,
    ...
    [MOVE_CHEMBOOST] =
    {
        .name = COMPOUND_STRING("Chem-boost"),
        .description = COMPOUND_STRING(
            "Uses some of its\n"
            "HP to raise all its stats."),
        .effect = EFFECT_CLANGOROUS_SOUL,
    ...
    [MOVE_SEASONED_STRIKE] =
    {
        .name = COMPOUND_STRING("Seasoned Strike"),
        .description = COMPOUND_STRING(
            "Attack type based on form\n"
            "may cause flinching."),
        .effect = EFFECT_SEASONAL,
        .power = 90,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_MAGNET_PUNCH] =
    {
        .name = COMPOUND_STRING("Magnet Punch"),
        .description = COMPOUND_STRING(
            "Super effective on Electric-\n"
    ...
    [MOVE_MYTHIC_CLAW] =
    {
        .name = COMPOUND_STRING("Mythic CLaw"),
        .description = COMPOUND_STRING(
            "Super effective on Fairy-\n"
            "types. May reduce DEF."),
        .effect = EFFECT_SUPER_EFFECTIVE_ON_ARG,
        .power = 70,
        .type = TYPE_DRAGON,
        .accuracy = 100,
    ...
    [MOVE_DRACO_STREAM] =
    {
        .name = COMPOUND_STRING("Draco Stream"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPECTRAL_SWIPE] =
    {
        .name = COMPOUND_STRING("Spectral Swipe"),
        .description = COMPOUND_STRING(
            "Only works first turn.\n"
    ...
    [MOVE_CYRO_FLARE] =
    {
        .name = COMPOUND_STRING("Cyro Flare"),
        .description = COMPOUND_STRING(
            "This move's power increases\n"
            "under harsh sunlight."),
        .effect = EFFECT_HYDRO_STEAM,
    ...
    {
        .name = COMPOUND_STRING("Whimsical Storm"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SHELL_SWORD] =
    {
        .name = COMPOUND_STRING("Shell Sword"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CRIMSON_STORM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "attack, lowers Sp. Atk."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 110 : 130,
        .type = TYPE_FIRE,
        .accuracy = 90,
        .pp = 5,
        .target = MOVE_TARGET_FOES_AND_ALLY,
    ...
    [MOVE_MAGMA_CANNON] =
    {
        .name = COMPOUND_STRING("Magma Cannon"),
        .description = COMPOUND_STRING(
            "Super effective on Water-\n"
    ...
    [MOVE_DUAL_CANNON] =
    {
        .name = COMPOUND_STRING("Dual Cannon"),
        .description = COMPOUND_STRING(
            "The user attacks twice. Two\n"
            "targets are hit once each."),
        .effect = EFFECT_DRAGON_DARTS,
    ...
    [MOVE_TANGLE_ARROW] =
    {
        .name = COMPOUND_STRING("Tangle Arrow"),
        .description = COMPOUND_STRING(
            "High critical hit ratio.\n"
    ...
    [MOVE_BUZZ_BURST] =
    {
        .name = COMPOUND_STRING("Buzz Burst"),
        .description = sCloseCombatDescription,
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_BUG,
    ...
    [MOVE_SINISTER_SLAM] =
    {
        .name = COMPOUND_STRING("Sinister Slam"),
        .description = COMPOUND_STRING(
            "A swinging fist attack\n"
            "that also lowers Speed."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_DUAL_SHACKLE] =
    {
        .name = COMPOUND_STRING("Dual Shackle"),
        .description = COMPOUND_STRING(
            "Slams the foe with 2 ghostly\n"
            "chains. May slow target."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_GHOST,
        .accuracy = 90,
    ...
    [MOVE_FLURRY_STRIKES] =
    {
        .name = COMPOUND_STRING("Flurry Strikes"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CALMING_AROMA] =
    {
        .name = COMPOUND_STRING("Calming Aroma"),
        .description = COMPOUND_STRING(
            "Sends soothing spores to\n"
            "cut Attack and Sp. Atk."),
        .effect = EFFECT_NOBLE_ROAR,
        .power = 0,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_FOAM_FANG] =
    {
        .name = COMPOUND_STRING("Foam Fang"),
        .description = COMPOUND_STRING(
            "Slows the opponent,\n"
            "may cause them to flinch."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_WATER,
        .accuracy = 95,
    ...
    [MOVE_FLARE_FIST] =
    {
        .name = COMPOUND_STRING("Flare Fist"),
        .description = COMPOUND_STRING(
            "A punch is thrown at blinding\n"
            "speed to strike first."),
        .effect = EFFECT_HIT,
     ...
     [MOVE_STEEL_CUTTER] =
    {
        .name = COMPOUND_STRING("Steel Cutter"),
        .description = COMPOUND_STRING(
            "Super effective on Steel-\n"
            "Types. May lower Def."),
        .effect = EFFECT_SUPER_EFFECTIVE_ON_ARG,
    ...
    [MOVE_STEEL_SHOT] =
    {
        .name = COMPOUND_STRING("Steel Shot"),
        .description = COMPOUND_STRING(
            "Shoots shrapnel 2 to 5 times.\n"
            "Ups Def, lowers Speed."),
        .effect = EFFECT_MULTI_HIT,
        .power = 25,
        .type = TYPE_STEEL,
        .accuracy = 90,
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .argument = MOVE_EFFECT_STEEL_SHOT,
        .contestEffect = CONTEST_EFFECT_NEXT_APPEAL_EARLIER,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_GHASTLY_BURST] =
    {
        .name = COMPOUND_STRING("Ghastly Burst"),
        .description = COMPOUND_STRING(
            "An attack that does more\n"
            "damage if an ally fainted."),
        .effect = EFFECT_RETALIATE,
    ...
    [MOVE_NOSEDIVE] =
    {
        .name = COMPOUND_STRING("Nosedive"),
        .description = COMPOUND_STRING(
            "Attacks from high in the\n"
            "air. May cause flinching."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_FLYING,
     ...
     [MOVE_TRIPLE_SPIKE] =
    {
        .name = COMPOUND_STRING("Triple Spike"),
        .description = COMPOUND_STRING(
            "A 3-sprung attack that gets\n"
            "more powerful with each hit."),
        .effect = EFFECT_TRIPLE_KICK,
        .power = 20,
        .type = TYPE_GROUND,
    ...
    [MOVE_FRIGID_PUNCH] =
    {
        .name = COMPOUND_STRING("Frigid Punch"),
        .description = sSuckerPunchDescription,
        .effect = EFFECT_SUCKER_PUNCH,
        .power = B_UPDATED_MOVE_DATA >= GEN_7 ? 70 : 80,
        .type = TYPE_ICE,
    ...
    [MOVE_ANCIENT_WING] =
    {
        .name = COMPOUND_STRING("Ancient Wing"),
        .description = COMPOUND_STRING(
            "This move's power increases\n"
            "when in sand."),
        .effect = EFFECT_SAND_BOOST,
        .power = 70,
        .type = TYPE_FLYING,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_SHELL_SLASH] =
    {
        .name = COMPOUND_STRING("Shell Slash"),
        .description = COMPOUND_STRING(
            "This move's power increases\n"
            "when in rain."),
        .effect = EFFECT_RAIN_BOOST,
        .power = 70,
        .type = TYPE_ROCK,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_SHELL_BURST] =
    {
        .name = COMPOUND_STRING("Shell burst"),
        .description = COMPOUND_STRING(
            "This move's power increases\n"
            "when in rain."),
        .effect = EFFECT_RAIN_BOOST,
    ...
    [MOVE_RAIN_BUFFER] =
    {
        .name = COMPOUND_STRING("Rain Buffer"),
        .description = COMPOUND_STRING(
            "Summons the rain for 5\n"
            "turns. Also boosts Def."),
        .effect = EFFECT_RAIN_DANCE,
        .power = 0,
        .type = TYPE_WATER,
        .accuracy = 0,
    ...
    [MOVE_BATTERING_RAM] =
    {
        .name = COMPOUND_STRING("Battering Ram"),
        .description = COMPOUND_STRING(
            "Slams the opponent with it's\n"
            "head. Ignores stat changes."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_ROCK,
        .accuracy = 100,
     ...
     [MOVE_PLATINUM_SHIELD] =
    {
        .name = COMPOUND_STRING("Platinum Shield"),
        .description = COMPOUND_STRING(
            "Raises Atk, Def and SpDef but,\n"
            "lowers Speed and SpAtk."),
        .effect = EFFECT_PLAT_SHIELD,
        .power = 0,
        .type = TYPE_STEEL,
        .accuracy = 0,
        .pp = 15,
    ...
    [MOVE_GEYSER_LAUNCH] =
    {
        .name = COMPOUND_STRING("Geyser Launch"),
        .description = COMPOUND_STRING(
            "Uses a geyser blast to\n"
            "launch at the enemy. Slows\n"
            "enemies."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_ROCK,
    ...
    [MOVE_STORM_SIPHON] =
    {
        .name = COMPOUND_STRING("Storm Siphon"),
        .description = COMPOUND_STRING(
            "An attack that steals half\n"
            "the damage inflicted."),
        .effect = EFFECT_ABSORB,
    ...
    [MOVE_TITAN_MAW] =
    {
        .name = COMPOUND_STRING("Titan Maw"),
        .description = COMPOUND_STRING(
            "Bites with vicious fangs.\n"
            "Always crits."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_EMPERORS_DIVE] =
    {
        .name = COMPOUND_STRING("Emperor's Dive"),
        .description = COMPOUND_STRING(
            "A swift dive that raises\n"
            "the user's Defense."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_WATER,
    ...
    [MOVE_AROMATIC_GALE] =
    {
        .name = COMPOUND_STRING("Aromatic Gale"),
        .description = COMPOUND_STRING(
            "Attacks with pheromones that\n"
            "eliminates all stat changes."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_BUG,
    ...
    [MOVE_UMBRAL_STRIKE] =
    {
        .name = COMPOUND_STRING("Umbral Strike"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SNEAKY_SCAM] =
    {
        .name = COMPOUND_STRING("Sneaky Scam"),
        .description = COMPOUND_STRING(
            "An quick witted attack\n"
            "that always strikes first."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_DARK,
    ...
    [MOVE_GLACIAL_TEMPEST] =
    {
        .name = COMPOUND_STRING("Glacial Tempest"),
        .description = COMPOUND_STRING(
            "Summons a tempest, then\n"
            "fires chilling blast."),
        .effect = EFFECT_TWO_TURNS_ATTACK,
        .power = 120,
        .type = TYPE_ICE,
        .accuracy = 100,
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .argument.twoTurnAttack = { .stringId = STRINGID_ELECTROSHOTCHARGING, .status = B_WEATHER_SNOW },
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SP_ATK_PLUS_1,
            .self = TRUE,
            .onChargeTurnOnly = TRUE,
    ...
    [MOVE_DESERT_STORM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Summons strong winds, then\n"
            "fires furious sandstorm."),
        .effect = EFFECT_TWO_TURNS_ATTACK,
        .power = 120,
        .type = TYPE_GROUND,
        .accuracy = 100,
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .argument.twoTurnAttack = { .stringId = STRINGID_ELECTROSHOTCHARGING, .status = B_WEATHER_SANDSTORM },
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SP_DEF_PLUS_1,
            .self = TRUE,
            .onChargeTurnOnly = TRUE,
    ...
    [MOVE_TREMOR_BARGE] =
    {
        .name = COMPOUND_STRING("Tremor Barge"),
        .description = COMPOUND_STRING(
            "Braces itself, then fires\n"
            "forward for a brutal strike."),
        .effect = EFFECT_TWO_TURNS_ATTACK,
        .power = 120,
        .type = TYPE_GROUND,
        .accuracy = 100,
    ...
    [MOVE_RESONANT_CRY] =
    {
        .name = COMPOUND_STRING("Resonant Cry"),
        .description = COMPOUND_STRING(
            "A loud attack that uses\n"
            "sound to create a veil."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_ICE,
        .accuracy = 90,
