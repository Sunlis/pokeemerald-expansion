...
0        .friendship = STANDARD_FRIENDSHIP,
...
#if FROSTY_MEGAS >= SPECIES_VENUSAUR
    [SPECIES_VENUSAUR_MEGA_Y] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_PRECISE_TACTICS, ABILITY_PRECISE_TACTICS, ABILITY_PRECISE_TACTICS },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Venusaur"),
        .cryId = CRY_VENUSAUR_MEGA,
        .natDexNum = NATIONAL_DEX_VENUSAUR,
...
#endif //FROSTY_MEGAS >= SPECIES_VENUSAUR
 ...
 0       //.backAnimId = BACK_ANIM_NONE,
    ...
    [SPECIES_CHARIZARD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_BLAZE, ABILITY_THERMAL_EXCHANGE, ABILITY_SOUL_HEART },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SQUIRTLE] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_SWIFT_SWIM, ABILITY_WATER_VEIL },
    ...
    [SPECIES_BLASTOISE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_TORRENT, ABILITY_MEGA_LAUNCHER, ABILITY_FOCUS_FLOOD },
        .bodyColor = BODY_COLOR_BLUE,
...
#if FROSTY_MEGAS >= SPECIES_BLASTOISE
    [SPECIES_BLASTOISE_MEGA_Y] =
    {
        ...
        .weight = 1011,
        .description = COMPOUND_STRING(
            "The cannons on its back are as powerful\n"
            "as turrets. Its tough legs and back\n"
            "enable it to withstand the recoil from\n"
            "the barrage it fires."),
        .pokemonScale = 256,
        .pokemonOffset = -1,
        .trainerScale = 293,
        .trainerOffset = 2,
...
#endif //FROSTY_MEGAS >= SPECIES_BLASTOISE
#endif //P_MEGA_EVOLUTIONS
...
#if P_MEGA_EVOLUTIONS
#if FROSTY_MEGAS >= SPECIES_BUTTERFREE
    [SPECIES_BUTTERFREE_MEGA] =
    {
        ...
        .baseDefense   = 60,    
        .baseSpeed     = 100,    //+20
        .baseSpAttack  = P_UPDATED_STATS >= GEN_6 ? 120 : 80,    //+30
        .baseSpDefense = 150,    //+50
        .types = MON_TYPES(TYPE_BUG, TYPE_FLYING),
        .catchRate = 45,
        .expYield = BUTTERFREE_EXP_YIELD,
        .evYield_SpAttack = 2,
...
#endif //FROSTY_MEGAS >= SPECIES_BUTTERFREE
...
#define BEEDRILL_ATTACK (P_UPDATED_STATS >= GEN_6 ? 90 : 80)
    ...
    [SPECIES_BEEDRILL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_TECHNICIAN, ABILITY_POISON_POINT, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    {
        .baseHP        = 65,
        .baseAttack    = BEEDRILL_ATTACK + 70,  //+10
        .baseDefense   = 60,    
        .baseSpeed     = 150,   //-10
        .baseSpAttack  = 15,
        .baseSpDefense = 80,
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
...
#if P_FAMILY_RATTATA        //not in this pokedex ignore for now (only for randomizer)
    [SPECIES_RATTATA] =
    {
        .baseHP        = 30,
        .baseAttack    = 56,
    ...
    [SPECIES_FEAROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SCRAPPY, ABILITY_INTIMIDATE, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_ARBOK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_SHED_SKIN, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Arbok"),
        .cryId = CRY_ARBOK,
    ...
    [SPECIES_PIKACHU] =     //changed regular pikachu to partner bsts
    {
        .baseHP        = 45,    //+10
        .baseAttack    = 80,    //+25
        .baseDefense   = P_UPDATED_STATS >= GEN_6 ? 50 : 30,    //+10
        .baseSpeed     = 120,   //+30
        .baseSpAttack  = 75,    //+25
        .baseSpDefense = P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 60 : 40,    //+10 was 50
        .types = MON_TYPES(TYPE_ELECTRIC),
        .catchRate = 190,
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_SANDSHREW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_VEIL, ABILITY_HYPER_CUTTER, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SANDSLASH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_TOUGH_CLAWS, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SANDSHREW_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_ROUGH_SKIN, ABILITY_SNOW_CLOAK },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Sandshrew"),
        .cryId = CRY_SANDSHREW,
        .natDexNum = NATIONAL_DEX_SANDSHREW,
    ...
    [SPECIES_SANDSLASH_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_FILTER, ABILITY_SNOW_CLOAK },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Sandslash"),
        .cryId = CRY_SANDSLASH,
        .natDexNum = NATIONAL_DEX_SANDSLASH,
    ...
    [SPECIES_NIDOQUEEN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_POISON_POINT, ABILITY_SOUL_HEART, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    {
        .baseHP        = 81,
        .baseAttack    = P_UPDATED_STATS >= GEN_6 ? 112 : 92,   //+10
        .baseDefense   = 77,
        .baseSpeed     = 85,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_POISON_POINT, ABILITY_NOXIOUS_ARMOR, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CLEFABLE] =
    {
        ...
        .baseDefense   = 73,
        .baseSpeed     = 60,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_6 ? 100 : 85,    //+5
        .baseSpDefense = 90,
        .types = CLEFAIRY_FAMILY_TYPES,
        .catchRate = 25,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
    ...
    [SPECIES_VULPIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DROUGHT, ABILITY_CURSED_BODY, ABILITY_FLAME_BODY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_NINETALES] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DROUGHT, ABILITY_CURSED_BODY, ABILITY_FLASH_FIRE },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define WIGGLYTUFF_SP_ATK   50
    ...
    [SPECIES_GOLBAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_INTIMIDATE, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_ODDISH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_GLOOM}), //21
    },
    ...
    [SPECIES_GLOOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_POISON_TOUCH, ABILITY_STENCH },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Gloom"),
        .cryId = CRY_GLOOM,
    ...
    [SPECIES_VILEPLUME] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_FOCUS_FLOOD, ABILITY_POISON_TOUCH, ABILITY_EFFECT_SPORE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_BELLOSSOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_GRASSY_SURGE, ABILITY_SUN_SOUL, ABILITY_PETAL_RIDER },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_PARASECT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_GRASS),
        .abilities = { ABILITY_TERRAFORM, ABILITY_DRY_SKIN, ABILITY_TRIAGE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_VENOMOTH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_WONDER_SKIN, ABILITY_TINTED_LENS, ABILITY_NOXIOUS_ARMOR },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_DIGLETT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ZEAL, ABILITY_ARENA_TRAP, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_POLIWRATH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_BULLY, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
...
#define ALAKAZAM_SP_DEF 135
...
#if P_MEGA_EVOLUTIONS
#if FROSTY_MEGAS >= SPECIES_MACHAMP
...
#endif //FROSTY_MEGAS >= SPECIES_MACHAMP
#endif //P_MEGA_EVOLUTIONS
    ...
    [SPECIES_BELLSPROUT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_PETAL_RIDER, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_WEEPINBELL}), //21
    },
    ...
    [SPECIES_VICTREEBEL] =
    {
        ...
        .baseSpeed     = 80,    //+10
        .baseSpAttack  = 100,
        .baseSpDefense = P_UPDATED_STATS >= GEN_6 ? 75 : 60, //+5 was 70:60
        .types = MON_TYPES(TYPE_GRASS, TYPE_POISON),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 245,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_PETAL_RIDER, ABILITY_BOUNTIFUL_BLOOM },
        .bodyColor = BODY_COLOR_GREEN,
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 130 : 110) //+10
    ...
    [SPECIES_GOLEM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SOLID_ROCK, ABILITY_STURDY, ABILITY_MOLD_BREAKER },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Golem"),
        .cryId = CRY_GOLEM,
    ...
    [SPECIES_PONYTA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_RAPIDASH}),     //40
    },
    ...
    [SPECIES_RAPIDASH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BULLY, ABILITY_FLASH_FIRE, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_PONYTA_GALAR] =
    {
        ...
        .formSpeciesIdTable = sPonytaFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_RAPIDASH_GALAR}),    //40
    },
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 100 : 65) //was 90 : 65
    ...
    [SPECIES_FARFETCHD] =
    {
        ...
        .abilities = { ABILITY_UNSEEN_FIST, ABILITY_INNER_FOCUS, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_DODRIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_BULLY, ABILITY_DEFIANT, ABILITY_AERILATE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_GRIMER] =
    {
        ...
        .abilities = { ABILITY_FILTER, ABILITY_STICKY_HOLD, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_MUK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_FOCUS_FLOOD, ABILITY_NEUROFORCE, ABILITY_TOXIC_CHAIN },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Muk"),
        .cryId = CRY_MUK,
...
#define GENGAR_ABILITIES {ABILITY_CURSED_BODY, ABILITY_SHADOW_SHIELD}
#else
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
...
#if FROSTY_MEGAS >= SPECIES_GENGAR
    [SPECIES_GENGAR_MEGA_Y] =
    {
        ...
        .trainerScale = 302,
        .trainerOffset = 2,
        .frontPic = gMonFrontPic_GengarMegaY,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 7,
        .frontAnimFrames = sAnims_GengarMega,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_GengarMegaY,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = gMonPalette_GengarMegaY,
        .shinyPalette = gMonShinyPalette_GengarMegaY,
        .iconSprite = gMonIcon_GengarMegaY,
        .iconPalIndex = 2,
        SHADOW(6, 1, SHADOW_SIZE_XL_BATTLE_ONLY)
        FOOTPRINT(Gengar)
        .isMegaEvolution = TRUE,
...
#endif //FROSTY_MEGAS >= SPECIES_GENGAR
#endif //P_MEGA_EVOLUTIONS
    ...
    [SPECIES_ONIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_STURDY, ABILITY_EARTH_EATER },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Onix"),
        .cryId = CRY_ONIX,
    ...
    [SPECIES_HYPNO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_INSOMNIA, ABILITY_DROWSY_AURA, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Hypno"),
        .cryId = CRY_HYPNO,
    ...
    [SPECIES_KRABBY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_SHELL_ARMOR, ABILITY_BULLY },
        .bodyColor = BODY_COLOR_RED,
...
#if P_MEGA_EVOLUTIONS
#if FROSTY_MEGAS >= SPECIES_KINGLER
...
#endif //FROSTY_MEGAS >= SPECIES_KINGLER
#endif //P_MEGA_EVOLUTIONS
    ...
    [SPECIES_ELECTRODE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_TRANSISTOR, ABILITY_STEELWORKER, ABILITY_AFTERMATH },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_SUN_SOUL, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_PINK,
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 85 : 65) //+10
    ...
    [SPECIES_EXEGGUTOR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_SUN_MAGE, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_EXEGGUTOR_ALOLA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_FRISK, ABILITY_SUN_SOUL, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Exeggutor"),
        .cryId = CRY_EXEGGUTOR,
        .natDexNum = NATIONAL_DEX_EXEGGUTOR,
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_MAROWAK},
                                {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_MAROWAK_ALOLA},
    ...
    [SPECIES_HITMONLEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_KICKBOXER, ABILITY_RECKLESS, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HITMONCHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_DUCK_N_WEAVE, ABILITY_IRON_FIST, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HITMONTOP] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_TECHNICIAN, ABILITY_SPINNER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LICKITUNG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_SERENE_GRACE, ABILITY_OBLIVIOUS },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_LICKILICKY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_SERENE_GRACE, ABILITY_CHEEK_POUCH },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_WEEZING},   //35
    ...
    [SPECIES_WEEZING] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_8
        .abilities = { ABILITY_LEVITATE, ABILITY_NEUTRALIZING_GAS, ABILITY_NEUROFORCE },
    #else
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_RHYHORN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_ROCK_HEAD, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_RHYPERIOR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_SOLID_ROCK, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_TANGROWTH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_BOUNTIFUL_BLOOM, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_KINGDRA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_SNIPER, ABILITY_DRAGONS_MAW },
    #else
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_NONE, ABILITY_DAMP },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SEAKING] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_REGENERATOR, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_MR_MIME_GALAR] =
    {
        ...
        .formSpeciesIdTable = sMrMimeFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 39, SPECIES_MR_RIME}),
    },
    ...
    [SPECIES_SCIZOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_SPEED_BOOST, ABILITY_LIGHT_METAL },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SMOOCHUM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_FOREWARN, ABILITY_ABSOLUTE_ZERO },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_JYNX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_PRODIGAL, ABILITY_DRY_SKIN },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Jynx"),
        .cryId = CRY_JYNX,
    ...
    [SPECIES_PINSIR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_DEFIANT, ABILITY_BULLY, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_TAUROS_PALDEA_COMBAT] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_ANGER_POINT, ABILITY_STAMINA },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Tauros"),
        .cryId = CRY_TAUROS,
        .natDexNum = NATIONAL_DEX_TAUROS,
...
#if P_MEGA_EVOLUTIONS
#if FROSTY_MEGAS >= SPECIES_LAPRAS
    [SPECIES_LAPRAS_MEGA] =
    {
        .baseHP        = 130,
        .baseAttack    = 110,    //+20
...
#endif //FROSTY_MEGAS >= SPECIES_LAPRAS
#endif //P_MEGA_EVOLUTIONS
...
#if P_FAMILY_EEVEE      //Changed to partner eevee stat line
    [SPECIES_EEVEE] =
    {
        .baseHP        = 65,        //+10
        .baseAttack    = 75,        //+20
    ...
    [SPECIES_EEVEE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TRUE_POWER, ABILITY_TRUE_POWER, ABILITY_TRUE_POWER },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Eevee"),
        .cryId = CRY_EEVEE,
        .natDexNum = NATIONAL_DEX_EEVEE,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_EeveeMega,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Eevee,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_EeveeMega,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 7,
        //.backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_EeveeMega,
        .shinyPalette = gMonShinyPalette_EeveeMega,
        .iconSprite = gMonIcon_EeveeMega,
        .iconPalIndex = 2,
...
#endif //FROSTY_MEGAS >= SPECIES_EEVEE
#endif //P_MEGA_EVOLUTIONS
    ...
    [SPECIES_FLAREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_HEAT_SINK, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_ESPEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_PRIDE, ABILITY_MAGIC_BOUNCE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_LEAFEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_PETAL_RIDER, ABILITY_CHLOROPHYLL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_GLACEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_ABSOLUTE_ZERO, ABILITY_SLUSH_RUSH },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_PORYGON2] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_TRACE, ABILITY_DOWNLOAD, ABILITY_MULTITYPE },
    #else
        .abilities = { ABILITY_TRACE, ABILITY_NONE, ABILITY_ANALYTIC },
    #endif
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_OMANYTE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_OMASTAR}),  //40
    },
    ...
    [SPECIES_KABUTO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_KABUTOPS}), //40
    },
    ...
    [SPECIES_KABUTOPS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_SHARPNESS, ABILITY_ANGER_SHELL},        
...
#if P_MEGA_EVOLUTIONS
#if FROSTY_MEGAS >= SPECIES_SNORLAX
    [SPECIES_SNORLAX_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_IMMUNITY, ABILITY_IMMUNITY, ABILITY_IMMUNITY },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Snorlax"),
        .cryId = CRY_SNORLAX,
        .natDexNum = NATIONAL_DEX_SNORLAX,
...
#endif // FROSTY_MEGAS >= SPECIES_SNORLAX
#endif // P_MEGA_EVOLUTIONS
    ...
    [SPECIES_MEWTWO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_NEUROFORCE, ABILITY_ADAPTABILITY, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_PURPLE,
