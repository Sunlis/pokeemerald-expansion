...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_RILLABOOM_MEGA_Y] =
    {
        ...
        .weight = 0,
        .description = COMPOUND_STRING(
            "Rillaboom has become one with it's\n"
            "surroundings, and has been known to\n"
            "withstand intense punishment in cover."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 365,
        .trainerOffset = 7,
        .frontPic = gMonFrontPic_RillaboomMegaY,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Rillaboom,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_RillaboomMegaY,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 4,
        //.backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_RillaboomMegaY,
        .shinyPalette = gMonShinyPalette_RillaboomMegaY,
        .iconSprite = gMonIcon_RillaboomMegaY,
        .iconPalIndex = 1,
        SHADOW(0, 8, SHADOW_SIZE_XL_BATTLE_ONLY)
        FOOTPRINT(Rillaboom)
        .isMegaEvolution = TRUE,
    ...
    [SPECIES_SOBBLE] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_SERENE_GRACE, ABILITY_SNIPER },
    ...
    [SPECIES_INTELEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_TORRENT, ABILITY_INFILTRATOR, ABILITY_WATER_BUBBLE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CORVIKNIGHT_MEGA] =
    {
        ...
        .weight = 0,
        .description = COMPOUND_STRING(
            "Imbued with powerful steel, its\n"
    ...
    [SPECIES_ORBEETLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_QUICK_WIT, ABILITY_INNER_FOCUS, ABILITY_TELEPATHY },
    ...
    [SPECIES_ORBEETLE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_GRAVITY_SURGE, ABILITY_GRAVITY_SURGE, ABILITY_GRAVITY_SURGE },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Orbeetle"),
        .cryId = CRY_ORBEETLE,
        .natDexNum = NATIONAL_DEX_ORBEETLE,
    ...
    [SPECIES_YAMPER] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BALL_FETCH, ABILITY_QUICK_FEET, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_COALOSSAL_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "earthbound flames stoking the fire,\n"
    ...
    [SPECIES_FLAPPLE] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_RIPEN, ABILITY_SUPERSWEET_SYRUP, ABILITY_PETAL_RIDER },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_APPLETUN] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_RIPEN, ABILITY_TERRAFORM, ABILITY_THICK_FAT },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SANDACONDA_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SANDY_SOUL, ABILITY_SANDY_SOUL, ABILITY_SANDY_SOUL },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Sandaconda"),
        .cryId = CRY_SANDACONDA,
        .natDexNum = NATIONAL_DEX_SANDACONDA,
    ...
    [SPECIES_GRAPPLOCT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_LIMBER, ABILITY_BULLY, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GRIMMSNARL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_PRANKSTER, ABILITY_TANGLING_HAIR, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GRIMMSNARL_MEGA] =
    {
        ...
        .weight = 0,
        .description = COMPOUND_STRING(
            "Mega Evolution has caused more\n"
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
     ...
     [SPECIES_ALCREMIE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                       
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_AMORPHOUS),      
        .abilities = { ABILITY_CONUNDRUM, ABILITY_CONUNDRUM, ABILITY_CONUNDRUM },  
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Alcremie"),
        .cryId = CRY_ALCREMIE,
        .natDexNum = NATIONAL_DEX_ALCREMIE,
    ...
    [SPECIES_COPPERAJAH_MEGA] =
    {
        ...
        .weight = 0,
        .description = COMPOUND_STRING(
            "After this Pokémon Mega Evolves,\n"
    ...
    [SPECIES_DURALUDON] =
    {
        ...
        .abilities = { ABILITY_LIGHT_METAL, ABILITY_LIGHTNING_ROD, ABILITY_STALWART },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_DURALUDON_MEGA] =
    {
        ...
        .trainerScale = 286,
        .trainerOffset = 1,
        .frontPic = gMonFrontPic_DuraludonMega,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Duraludon,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_DuraludonMega,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        //.backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_DuraludonMega,
        .shinyPalette = gMonShinyPalette_DuraludonMega,
        .iconSprite = gMonIcon_DuraludonMega,
        .iconPalIndex = 0,
    ...
    [SPECIES_DREEPY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 46, SPECIES_DRAKLOAK}), //50
    },
    ...
    [SPECIES_DRAKLOAK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 55, SPECIES_DRAGAPULT}),    //60
    },
