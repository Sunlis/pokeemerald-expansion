...
.evYield_Attack = 3,
    ...
    [SPECIES_BURMY_PLANT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_WORMADAM_PLANT, CONDITIONS({IF_GENDER, MON_FEMALE})},   //20
                                {EVO_LEVEL, 18, SPECIES_MOTHIM_PLANT, CONDITIONS({IF_GENDER, MON_MALE})}),  //20
    },
    ...
    [SPECIES_BURMY_SANDY] =
    {
        ...
        .formSpeciesIdTable = sBurmyFormSpeciesIdTable,
        .formChangeTable = sBurmyFormChangeTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_WORMADAM_SANDY, CONDITIONS({IF_GENDER, MON_FEMALE})},   //20
                                {EVO_LEVEL, 18, SPECIES_MOTHIM_SANDY, CONDITIONS({IF_GENDER, MON_MALE})}),      //20
    },
    ...
    [SPECIES_BURMY_TRASH] =
    {
        ...
        .formSpeciesIdTable = sBurmyFormSpeciesIdTable,
        .formChangeTable = sBurmyFormChangeTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_WORMADAM_TRASH, CONDITIONS({IF_GENDER, MON_FEMALE})},   //20
                                {EVO_LEVEL, 18, SPECIES_MOTHIM_TRASH, CONDITIONS({IF_GENDER, MON_MALE})}),      //20
    },
