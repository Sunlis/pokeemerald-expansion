...
enum ItemHoldEffect
{
    ...
    HOLD_EFFECT_MUSIC_BOX,       
    HOLD_EFFECT_BLADE_ARMOR,         
    HOLD_EFFECT_HOENN_SEACAKE,       
    HOLD_EFFECT_SPIRIT_CHIME,        
    HOLD_EFFECT_CAMO_CLOAK, 
    HOLD_EFFECT_FROST_ORB,   
    HOLD_EFFECT_RIOT_SHIELD,    
    HOLD_EFFECT_SNIPER_GOGGLES,
    // #define ITEM_GLUE_TRAP 883
    // #define ITEM_RESET_BUTTON 884
    HOLD_EFFECT_SAND_BAG,
    HOLD_EFFECT_HARD_HAT,
    HOLD_EFFECT_ITEM_LOVERS_GIFT,
    HOLD_EFFECT_IRON_MASK, 
    HOLD_EFFECT_MARACCAS,
    // #define ITEM_SOUL_LANTERN 896   //buff spiritomb
    HOLD_EFFECT_MOLT_BERRY,
    HOLD_EFFECT_ZAPPA_BERRY,
    HOLD_EFFECT_ARCTI_BERRY,
    HOLD_EFFECT_SUB_BERRY,
