...
enum StringID
{
    ...
    STRINGID_DUCKNWEAVEACTIVATES,                  
    STRINGID_PKMNDROPPEDITEM,
    STRINGID_ADDEDTOBAG,
    STRINGID_BAGISFULL,
    STRINGID_GRASSYTERRAINACTIVATEDABILITY,
    STRINGID_PSYCHICTERRAINACTIVATEDABILITY,
    STRINGID_MISTYTERRAINACTIVATEDABILITY,
    STRINGID_PKMNCUTSSPATTACKWITH,
    STRINGID_PKMNSXPREVENTSFROSTBITE,
    STRINGID_BLASTBURNISCHARGING,
    STRINGID_HYDROCANNONISCHARGING,
    STRINGID_PKMNALREADYHASFROSTBITE,
    STRINGID_SNOWSTALKERHPDROP,
    STRINGID_SANDACTIVATEDABILITY,
    STRINGID_HARDHATIN,
    STRINGID_SANDBAGIN,
    STRINGID_HARDHATPOP,
    STRINGID_SANDBAGPOP,
    STRINGID_SUBBERRY,
    STRINGID_STEELSURGESWITCHIN,
    STRINGID_COUNT
};
